...
| **70.00.100A** | EU | cmu150_EU_70.00.100A_failsafe.up; ..._reinstall.up | failsafe+reinstall | reinstall ~2.3 GB (comm) | — | failsafe MD5 `cc485f4f16541cd803f615df42dc3512` ✓ **[dl]**; reinstall MD5 `d5c042588b5de7f0d72e02b03ec78590` ✓ **[dl]** (the rival `279f1b81…` is a bad/older copy) | Mazda-USA-CDN (403); GDrive `FIAT 124 CarPlay files EU.zip`; navi-world €29.99; PM | known-hash ❓ | **Contradiction resolved 2026-08-23**: the file we hold matches `d5c0…`; `279f…` was jayrock's 2020 copy, the one that threw "Invalid packet certificate". ⚠️ Both sources for `d5c0…` are GDrive re-hosts and may share an upstream | [A-3][B-2.3][D-02][D-07] |
...
2. ~~**EU & ADR firmware still missing**~~ → **DONE 2026-08-23.** Both 70.00.100A pairs obtained from the
   124spider.org GDrive bundles and hash-checked; all four halves match their community MD5s. The Mazda
   CDN still serves NA only (EU/ADR objects 403), so those regions depend on community re-hosts. [D-07]
